...
//		this.setPreferredSize(new Dimension(Tetris.PANEL_WIDTH_GAME, Tetris.PANEL_HEIGHt_GAME));
	...
	private void loadImage() {
		bufBackground=new BufferedImage(Tetris.PANEL_WIDTH_GAME, Tetris.PANEL_HEIGHt_GAME, BufferedImage.TYPE_INT_ARGB);
		try {
	...
	private void createBlurredImage() {
        ...
        bluri = blur.filter(bufBackground, new BufferedImage(bufBackground.getWidth(),
        		bufBackground.getHeight(), bufBackground.getType()));
    }
...
//	}
	public void doDrawing(Graphics g) {
		...
		rectNewGame.setFrame( (Tetris.PANEL_WIDTH_GAME - stringWidth2) / 2, Tetris.PANEL_HEIGHt_GAME / 2-40+20, stringWidth2, 30);
        gd.fill(rectNewGame);
        ...
        gd.setColor(new Color(0,0,0,0));
        rectQuitGame.setFrame((Tetris.PANEL_WIDTH_GAME - stringWidth2) / 2, Tetris.PANEL_HEIGHt_GAME / 2+25, stringWidth2,30);
